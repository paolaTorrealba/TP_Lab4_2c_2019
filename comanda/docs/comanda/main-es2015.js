...
CancelarPedidoComponent.ctorParameters = () => [
    { type: src_app_servicios_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: src_app_providers_auth__WEBPACK_IMPORTED_MODULE_4__["AuthProvider"] }
];
...
ConfirmarPagoComponent.ctorParameters = () => [
    { type: src_app_servicios_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: src_app_providers_auth__WEBPACK_IMPORTED_MODULE_3__["AuthProvider"] }
];
        ...
        this.data.getListaPedidos("pedidos").subscribe(lista => {
            ...
            for (let i = 0; i <= this.pedidos.length - 1; i++) {
                ...
                if (this.pedidos[i].correo == this.correo) {
                    if (this.pedidos[i].estado == src_app_clases_enum__WEBPACK_IMPORTED_MODULE_6__["EstadoPedido"].pagado) {
...
PagarFacturaComponent.ctorParameters = () => [
    { type: src_app_servicios_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: src_app_providers_auth__WEBPACK_IMPORTED_MODULE_4__["AuthProvider"] }
];
...
VerEncuestasComponent.ctorParameters = () => [
    { type: src_app_servicios_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: src_app_providers_auth__WEBPACK_IMPORTED_MODULE_3__["AuthProvider"] }
];
